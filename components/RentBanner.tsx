...
function RentBanner(props: TRentBannerProps) {
  const { carName } = props;
  return (
    <div className="flex flex-col justify-start p-4 bg-gradient-to-r from-yellow-500 to-yellow-400 text-white md:w-2/3 w-10/12 rounded-lg animate-pulse m-auto gap-4">
      ...
      <p className="text-lg">
        Simply fill out the details presented below and we will get back to you
        as soon as possible to confirm your reservation
      </p>
      <Image
